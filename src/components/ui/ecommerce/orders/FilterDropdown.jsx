  ...
  return (
    <div className="relative ">
      <button 
        ...
        className="p-2 relative rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors flex items-center space-x-1"
      >
        <ListFilter className="h-4 w-4" />
       
      </button>
      {showFilterDropdown && (
        <div className="absolute right-[-3] z-[10000] mt-2 w-42 bg-gray-100 border dark:bg-neutral-900 dark:border-neutral-700 dark:text-white border-gray-200 rounded-lg shadow-lg ">
          <div className="py-2">
