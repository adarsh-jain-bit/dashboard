  ...
  return (
    <header className="flex sticky top-0 w-full items-center justify-between h-16 py-2 px-4 border-b bg-white dark:bg-[#1c1c1c]">
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        >
          {!isDark ? (
            <img src="/assets/Sidebar.png" className="h-6 w-6" />
          ) : (
            <img src="/assets/sidebarwhite.png" className="h-6 w-6" />
          )}
        </button>
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md hidden md:flex">
        ...
        <button className="p-2 hover:bg-gray-100 flex md:hidden dark:hover:bg-gray-800 rounded-md">
